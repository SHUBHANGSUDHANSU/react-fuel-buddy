...
export default function DieselOnTap() {
    ...
    <div id="cms-page" className="cms-page">
                    ...
                    <ul id="cms-primary-menu" className="cms-primary-menu clearfix">
                      ...
                      <li id="menu-item-6022" className="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-6022">
                        ...
                        <ul className="sub-menu">
                          ...
                          <li id="menu-item-6028" className="menu-item menu-item-type-post_type menu-item-object-solutions current-menu-item menu-item-6028">
                            <a href="/solutions/diesel-on-tap" aria-current="page" className="cms-menu-link">
                              <span className="menu-title-wraps">
                                <span className="menu-title title">
                                  DOT (Diesel on Tap)
                                </span>
      ...
      <div id="cms-main" className="cms-main cms-main-elementor">
        <div className="cms-content-container elementor-container">
          <div data-elementor-type="wp-post" data-elementor-id="678" className="elementor elementor-678" data-elementor-post-type="solutions">
            <div className="elementor-section elementor-top-section elementor-element elementor-element-7c65beba elementor-section-full_width elementor-section-height-default elementor-section-height-default cms-remove-container-max-width-no cms-full-content-with-space-none cms-boxed-bg-false cms-overlay-gradient-mode-bt cms-overlay-gradient-bg-yes" data-id="7c65beba" data-element_type="section">
              <div className="cms-overlay-gradient"></div>
              <div className="cms-section-boxed-bg"></div>
              <div className="elementor-container elementor-column-gap-no">
                <div className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-9751154" data-id="9751154" data-element_type="column">
                  <div className="elementor-widget-wrap elementor-element-populated">
                    <div className="elementor-element elementor-element-6dc5a904 cms-page-title-layout-4 elementor-widget elementor-widget-cms_page_title" data-id="6dc5a904" data-element_type="widget" data-widget_type="cms_page_title.default">
                      <div className="elementor-widget-container">
                        <div className="cms-page-title-wrapper cms-overlay-gradient-1 text-center" style={{backgroundImage: "url(https://www.fuelbuddy.in/wp-content/uploads/2022/10/7.jpg)"}}>
                              ...
                              <div className="cms-page-title-content-col col-12 col-tablet-8 col-desktop-6">
                                <div className="cms-page-title-content">
                                  ...
                                  <div className="cms-desc text-17 font-700 pt-20 mt-n3 text-white">
                                    Diesel-on-Tap: Monitoring Diesel Management with Ease and Convenience 
                                    <div className="extra-space clearfix"></div>
                                  </div>
            ...
            <div className="elementor-section elementor-top-section elementor-element elementor-element-2b252f3a p-tb-40 p-tb-tablet-90 elementor-reverse-mobile elementor-section-boxed elementor-section-height-default elementor-section-height-default cms-remove-container-max-width-no cms-boxed-bg-false cms-overlay-gradient-mode-bt cms-overlay-gradient-bg-yes" data-id="2b252f3a" data-element_type="section">
              <div className="cms-overlay-gradient"></div>
              <div className="cms-section-boxed-bg"></div>
              <div className="elementor-container elementor-column-gap-default">
                <div className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-1672c62" data-id="1672c62" data-element_type="column">
                  <div className="elementor-widget-wrap elementor-element-populated">
                    <div className="elementor-element elementor-element-4bbe766 cms-form-field-border-grey4 cms-form-field-border-grey4 cms-cf7-layout-1 elementor-widget elementor-widget-global elementor-global-5465 elementor-widget-cms_ctf7" data-id="4bbe766" data-element_type="widget" data-settings={"{\"sticky\":\"top\",\"sticky_parent\":\"yes\",\"motion_fx_motion_fx_scrolling\":\"yes\",\"motion_fx_devices\":[\"desktop\",\"tablet_extra\",\"tablet\",\"mobile\"],\"sticky_on\":[\"desktop\",\"tablet_extra\",\"tablet\",\"mobile\"],\"sticky_offset\":0,\"sticky_effects_offset\":0}"} data-widget_type="cms_ctf7.default">
                      <div className="elementor-widget-container">
                        <div className="cms-cf7 relative p-tb-50 p-lr-20 p-lr-lg-50 bg-white cms-shadow-1 cms-radius-16">
                          <div className="cms-cf7-inner">
                            ...
                            <div className="wpcf7 no-js" id="wpcf7-f1514-p678-o1" lang="en-US" dir="ltr">
                              <div className="screen-reader-response">
                                <p role="status" aria-live="polite" aria-atomic="true"></p>
                                <ul></ul>
                              </div>
                              <form action="https://formspree.io/f/xkoowlbe" method="post" className="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init" data-form-key="diesel-on-tap" onSubmit={handleSubmit}>
                                <input type="hidden" name="form_source" value="DOT (Diesel on Tap) - Quote Form" />
                                <div style={{display: "none"}}>
                                  <input type="hidden" name="_wpcf7" value="1514" />
                                  <input type="hidden" name="_wpcf7_version" value="5.9.3" />
                                  <input type="hidden" name="_wpcf7_locale" value="en_US" />
                                  <input type="hidden" name="_wpcf7_unit_tag" value="wpcf7-f1514-p678-o1" />
                                ...
                                <div className="row gutters-30">
                                  ...
                                  <div className="col-12 col-tablet-auto pt-15">
                                    <p>
                                      ...
                                      {formStatus["diesel-on-tap"] === "loading" && (
                                        <div style={{ marginTop: 12 }}>
                                          Sending...
                                        </div>
                                      )}
                                      {formStatus["diesel-on-tap"] === "success" && (
                                        <div style={{ color: "#1a7f37", marginTop: 12 }}>
                                          Thank you! We will get back to you soon.
                                        </div>
                                      )}
                                      {formStatus["diesel-on-tap"] === "error" && (
                                ...
                                <p style={{display: "none"}} className="akismet-fields-container" data-prefix="_wpcf7_ak_">
                                  ...
                                  <input type="hidden" id="ak_js_1" name="_wpcf7_ak_js" value="249" />
                                </p>
                ...
                <div className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-6144b128" data-id="6144b128" data-element_type="column">
                  <div className="elementor-widget-wrap elementor-element-populated">
                    <div className="elementor-element elementor-element-c69c1c1 elementor-widget elementor-widget-heading" data-id="c69c1c1" data-element_type="widget" data-widget_type="heading.default">
                      <div className="elementor-widget-container">
                    ...
                    <div className="elementor-element elementor-element-518bac0 elementor-widget elementor-widget-text-editor" data-id="518bac0" data-element_type="widget" data-widget_type="text-editor.default">
                      <div className="elementor-widget-container">
                        <style dangerouslySetInnerHTML={{ __html: `
                        ...
                        ` }} />
                         Are you looking for a simple and efficient way to manage your diesel needs? Look no further! We present to you Diesel-on-Tap, a user-friendly solution that is durable & movable. With options available in 500 liters, 1000 liters, and 2000 liters, it's suitable for multiple business segments. 
                      </div>
                    </div>
                    <div className="elementor-element elementor-element-78a8eb8 elementor-widget elementor-widget-heading" data-id="78a8eb8" data-element_type="widget" data-widget_type="heading.default">
                      <div className="elementor-widget-container">
                        <h2 className="elementor-heading-title elementor-size-default">
                          What Makes It Great?
                        </h2>
                    ...
                    <div className="elementor-element elementor-element-a87ccea elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list" data-id="a87ccea" data-element_type="widget" data-widget_type="icon-list.default">
                      <div className="elementor-widget-container">
                        ...
                        <ul className="elementor-icon-list-items">
                          <li className="elementor-icon-list-item">
                            ...
                            <span className="elementor-icon-list-text">
                              Comfortable Handle: Our user-friendly handle ensures effortless cap opening.
                            </span>
                          </li>
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              Digital Diesel Meter: Keep track of your Diesel consumption accurately.
                            </span>
                          </li>
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              Remote Monitoring: Use a smart card to monitor your Diesel remotely.
                            </span>
                          </li>
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              Keypad: Secure access with a passcode for added safety.
                            </span>
                          </li>
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              Power Indicator: Know the status of your power supply immediately.
                            </span>
                          </li>
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              Emergency Stop Switch: In case of emergencies, just push the button to cut the power.
                            </span>
                          </li>
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              Spill-proof Dispensing Unit: No more messy spills while dispensing.
                            </span>
                          </li>
                        </ul>
                      </div>
                    </div>
                    <div className="elementor-element elementor-element-0962f8d elementor-widget elementor-widget-heading" data-id="0962f8d" data-element_type="widget" data-widget_type="heading.default">
                      <div className="elementor-widget-container">
                        <h2 className="elementor-heading-title elementor-size-default">
                          Why You'll Love It?
                        </h2>
                    ...
                    <div className="elementor-element elementor-element-9b53bbc elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list" data-id="9b53bbc" data-element_type="widget" data-widget_type="icon-list.default">
                      <div className="elementor-widget-container">
                        <ul className="elementor-icon-list-items">
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              Save Money: Monitor the quality and quantity of diesel, reducing losses due to dead trips and pilferage from open barrels.
                            </span>
                          </li>
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              Save Time: Ensure your vehicles are ready 24/7, eliminating worries about refueling.
                            </span>
                          </li>
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              Faster Reconciliation: Access digital filling data to update your diesel management system quickly and reduce reconciliation time.
                            </span>
                          </li>
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              Shift As Required: Our movable design allows you to shift your system anywhere you need.
                            </span>
                          </li>
                        </ul>
                      </div>
                    </div>
                    <div className="elementor-element elementor-element-bb40c92 elementor-widget-tablet_extra__width-initial elementor-widget elementor-widget-heading" data-id="bb40c92" data-element_type="widget" data-widget_type="heading.default">
                      <div className="elementor-widget-container">
                        <h2 className="elementor-heading-title elementor-size-default">
                    ...
                    <div className="elementor-element elementor-element-8a4f0fc elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list" data-id="8a4f0fc" data-element_type="widget" data-widget_type="icon-list.default">
                      <div className="elementor-widget-container">
                        <ul className="elementor-icon-list-items">
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                    ...
                    <div className="elementor-element elementor-element-56ec94a9 pt-20 elementor-hidden-desktop elementor-hidden-tablet_extra elementor-hidden-tablet elementor-hidden-mobile cms-charts cms-chart-layout-1 elementor-widget elementor-widget-cms_chart" data-id="56ec94a9" data-element_type="widget" data-widget_type="cms_chart.default">
                      <div className="elementor-widget-container">
                          ...
                          <div className="col-mobile-6 pt-50">
                            <div className="cms-sticky">
                              <div className="cms-charts-chart m-lr-auto mb-20">
                                <canvas id="cms_chart-56ec94a9" className="cms-charts" data-settings={"{\"type\":\"doughnut\",\"labels\":[\"Retail\",\"Sciences\",\"Industrial\",\"Power\",\"Oil & Gas\"],\"value\":[40,20,15,15,10],\"colors\":[\"#9bcb3b\",\"#5553ce\",\"#f13a30\",\"#f8a137\",\"#1875f0\"],\"legend_display\":\"false\",\"legend_position\":null,\"title_display\":\"false\",\"title_position\":null,\"title_text\":null}"}></canvas>
                              </div>
            ...
            <div className="elementor-element elementor-element-690cbcf e-flex e-con-boxed e-con e-parent" data-id="690cbcf" data-element_type="container" data-settings={"{\"content_width\":\"boxed\"}"} data-core-v316-plus="true">
              <div className="e-con-inner">
                <div className="elementor-element elementor-element-119aeb8 elementor-widget elementor-widget-shortcode" data-id="119aeb8" data-element_type="widget" data-widget_type="shortcode.default">
                  <div className="elementor-widget-container">
                      ...
                      <div className="cms-menu-wraps relative">
                        ...
                        <div className="menu-solutions-footer-container">
                          <ul id="menu-solutions-footer" className="cms-menu cms-menu-vert -">
                            <li id="menu-item-4506" className="menu-item menu-item-type-post_type menu-item-object-solutions current-menu-item menu-item-4506">
                              <a href="/solutions/diesel-on-tap" aria-current="page" className="cms-menu-link link-white link-hover-accent bg-transparent bg-hover-transparent text-14">
                                <span className="menu-title title">
                                  DOT (Diesel on Tap)
                                </span>
                              </a>
