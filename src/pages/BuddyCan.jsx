    ...
    <div id="cms-page" className="cms-page">
                  ...
                  <div className="cms-main-navigation col-12 col-desktop-auto">
                    <ul id="cms-primary-menu" className="cms-primary-menu clearfix">
                      ...
                      <li id="menu-item-6022" className="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-6022">
                        ...
                        <ul className="sub-menu">
                          <li id="menu-item-6030" className="menu-item menu-item-type-post_type menu-item-object-solutions current-menu-item menu-item-6030">
                            <a href="/solutions/buddy-can" aria-current="page" className="cms-menu-link">
                              <span className="menu-title-wraps">
                                <span className="menu-title title">
                                  Buddy Can
                                </span>
      ...
      <div id="cms-main" className="cms-main cms-main-elementor">
        <div className="cms-content-container elementor-container">
          <div data-elementor-type="wp-post" data-elementor-id="674" className="elementor elementor-674" data-elementor-post-type="solutions">
            <div className="elementor-section elementor-top-section elementor-element elementor-element-126c420b elementor-section-full_width elementor-section-height-default elementor-section-height-default cms-remove-container-max-width-no cms-full-content-with-space-none cms-boxed-bg-false cms-overlay-gradient-mode-bt cms-overlay-gradient-bg-yes" data-id="126c420b" data-element_type="section">
              <div className="cms-overlay-gradient"></div>
              <div className="cms-section-boxed-bg"></div>
              <div className="elementor-container elementor-column-gap-no">
                <div className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-6ed4b39e" data-id="6ed4b39e" data-element_type="column">
                  <div className="elementor-widget-wrap elementor-element-populated">
                    <div className="elementor-element elementor-element-7ee67c1a cms-page-title-layout-4 elementor-widget elementor-widget-cms_page_title" data-id="7ee67c1a" data-element_type="widget" data-widget_type="cms_page_title.default">
                      <div className="elementor-widget-container">
                        <div className="cms-page-title-wrapper cms-overlay-gradient-1 text-center" style={{backgroundImage: "url(https://www.fuelbuddy.in/wp-content/uploads/2022/10/8.jpg)"}}>
                              ...
                              <div className="cms-page-title-content-col col-12 col-tablet-8 col-desktop-6">
                                <div className="cms-page-title-content">
                                  ...
                                  <div className="cms-desc text-17 font-700 pt-20 mt-n3 text-white">
                                    Your Smart, Secure, Easy to Carry, PESO-Approved 20-Litre Containers 
                                    <div className="extra-space clearfix"></div>
                                  </div>
            ...
            <div className="elementor-section elementor-top-section elementor-element elementor-element-70ee48bc p-tb-40 p-tb-tablet-90 elementor-reverse-mobile elementor-section-boxed elementor-section-height-default elementor-section-height-default cms-remove-container-max-width-no cms-boxed-bg-false cms-overlay-gradient-mode-bt cms-overlay-gradient-bg-yes" data-id="70ee48bc" data-element_type="section">
              <div className="cms-overlay-gradient"></div>
              <div className="cms-section-boxed-bg"></div>
              <div className="elementor-container elementor-column-gap-default">
                <div className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-4b21b2e4" data-id="4b21b2e4" data-element_type="column">
                  <div className="elementor-widget-wrap elementor-element-populated">
                    <div className="elementor-element elementor-element-5f1a2775 elementor-widget elementor-widget-heading" data-id="5f1a2775" data-element_type="widget" data-widget_type="heading.default">
                      <div className="elementor-widget-container">
                    ...
                    <div className="elementor-element elementor-element-7be0080d elementor-widget elementor-widget-text-editor" data-id="7be0080d" data-element_type="widget" data-widget_type="text-editor.default">
                      <div className="elementor-widget-container">
                        <style dangerouslySetInnerHTML={{ __html: `
                        ...
                        ` }} />
                        <p>
                          Discover an effortless way to store diesel with our smart, PESO-approved 20-liter containers. Say goodbye to leaks and worries, and welcome secure solutions for your daily and emergency Diesel needs in apartments, offices, and equipment.
                        </p>
                      </div>
                    </div>
                    <div className="elementor-element elementor-element-68cbf75 elementor-widget elementor-widget-heading" data-id="68cbf75" data-element_type="widget" data-widget_type="heading.default">
                      <div className="elementor-widget-container">
                        <h2 className="elementor-heading-title elementor-size-default">
                          What Makes It Great?
                        </h2>
                    ...
                    <div className="elementor-element elementor-element-1cea140e elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list" data-id="1cea140e" data-element_type="widget" data-widget_type="icon-list.default">
                      <div className="elementor-widget-container">
                        ...
                        <ul className="elementor-icon-list-items">
                          <li className="elementor-icon-list-item">
                            ...
                            <span className="elementor-icon-list-text">
                              Holds 20 Liters: Have 20 litres of diesel at hand, always ready.
                            </span>
                          </li>
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              No Spills: No mess, no wastage – it's made to keep things clean and tidy.
                            </span>
                          </li>
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              Built to Last: It's strong and safe, thanks to a petroleum-resistant paint.
                            </span>
                          </li>
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              Easy to Fill: A wide spout makes it simple to pour without spills.
                            </span>
                          </li>
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              Strong yet Light: It's tough yet easy to carry.
                            </span>
                          </li>
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              Versatile: Use it for all your diesel storage and transportation needs.
                            </span>
                          </li>
                        </ul>
                      </div>
                    </div>
                    <div className="elementor-element elementor-element-40cecaeb elementor-widget elementor-widget-heading" data-id="40cecaeb" data-element_type="widget" data-widget_type="heading.default">
                      <div className="elementor-widget-container">
                        <h2 className="elementor-heading-title elementor-size-default">
                          Why You'll Love It?
                        </h2>
                    ...
                    <div className="elementor-element elementor-element-514672ee elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list" data-id="514672ee" data-element_type="widget" data-widget_type="icon-list.default">
                      <div className="elementor-widget-container">
                        <ul className="elementor-icon-list-items">
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              Always Prepared: Feel secure knowing you have a reliable Diesel source whenever you need it
                            </span>
                          </li>
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              Stay Safe: Features that prevent spillage and ensures safety for you and your surroundings
                            </span>
                          </li>
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              No More Wastage of Diesel: Say goodbye to spilling valuable Diesel.
                            </span>
                          </li>
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                            ...
                            <span className="elementor-icon-list-text">
                              Simple to Use: Pour Diesel without the need for a funnel.
                            </span>
                          </li>
                        </ul>
                      </div>
                    </div>
                    <div className="elementor-element elementor-element-3071b4c2 elementor-widget elementor-widget-heading" data-id="3071b4c2" data-element_type="widget" data-widget_type="heading.default">
                      <div className="elementor-widget-container">
                        <h2 className="elementor-heading-title elementor-size-default">
                    ...
                    <div className="elementor-element elementor-element-8b4c723 elementor-icon-list--layout-traditional elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list" data-id="8b4c723" data-element_type="widget" data-widget_type="icon-list.default">
                      <div className="elementor-widget-container">
                        <ul className="elementor-icon-list-items">
                          <li className="elementor-icon-list-item">
                            <span className="elementor-icon-list-icon">
                ...
                <div className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-7edbc4b elementor-hidden-tablet elementor-hidden-mobile" data-id="7edbc4b" data-element_type="column" data-settings={"{\"motion_fx_motion_fx_scrolling\":\"yes\",\"motion_fx_devices\":[\"desktop\",\"tablet_extra\",\"tablet\",\"mobile\"]}"}>
                  <div className="elementor-widget-wrap elementor-element-populated">
                    <div className="elementor-element elementor-element-3d9284b cms-form-field-border-grey4 cms-form-field-border-grey4 cms-cf7-layout-1 elementor-widget elementor-widget-global elementor-global-5465 elementor-widget-cms_ctf7" data-id="3d9284b" data-element_type="widget" data-settings={"{\"sticky\":\"top\",\"sticky_parent\":\"yes\",\"motion_fx_motion_fx_scrolling\":\"yes\",\"motion_fx_devices\":[\"desktop\",\"tablet_extra\",\"tablet\",\"mobile\"],\"sticky_on\":[\"desktop\",\"tablet_extra\",\"tablet\",\"mobile\"],\"sticky_offset\":0,\"sticky_effects_offset\":0}"} data-widget_type="cms_ctf7.default">
                      <div className="elementor-widget-container">
                        <div className="cms-cf7 relative p-tb-50 p-lr-20 p-lr-lg-50 bg-white cms-shadow-1 cms-radius-16">
                          <div className="cms-cf7-inner">
                            ...
                            <div className="wpcf7 no-js" id="wpcf7-f1514-p674-o1" lang="en-US" dir="ltr">
                              ...
                              <form action="/solutions/buddy-can/#wpcf7-f1514-p674-o1" method="post" className="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
                                ...
                                <p style={{display: "none"}} className="akismet-fields-container" data-prefix="_wpcf7_ak_">
                                  ...
                                  <input type="hidden" id="ak_js_1" name="_wpcf7_ak_js" value="125" />
                                </p>
            ...
            <div className="elementor-element elementor-element-9b24421 elementor-hidden-desktop elementor-hidden-tablet_extra elementor-hidden-tablet e-flex e-con-boxed e-con e-parent" data-id="9b24421" data-element_type="container" data-settings={"{\"content_width\":\"boxed\"}"} data-core-v316-plus="true">
              <div className="e-con-inner">
                <div className="elementor-element elementor-element-5a20d4f cms-form-field-border-grey4 cms-form-field-border-grey4 cms-cf7-layout-1 elementor-widget elementor-widget-global elementor-global-5465 elementor-widget-cms_ctf7" data-id="5a20d4f" data-element_type="widget" data-settings={"{\"sticky\":\"top\",\"sticky_parent\":\"yes\",\"motion_fx_motion_fx_scrolling\":\"yes\",\"motion_fx_devices\":[\"desktop\",\"tablet_extra\",\"tablet\",\"mobile\"],\"sticky_on\":[\"desktop\",\"tablet_extra\",\"tablet\",\"mobile\"],\"sticky_offset\":0,\"sticky_effects_offset\":0}"} data-widget_type="cms_ctf7.default">
                  <div className="elementor-widget-container">
                    <div className="cms-cf7 relative p-tb-50 p-lr-20 p-lr-lg-50 bg-white cms-shadow-1 cms-radius-16">
                      <div className="cms-cf7-inner">
                        <div className="cms-banner">
                        ...
                        <div className="wpcf7 no-js" id="wpcf7-f1514-p674-o2" lang="en-US" dir="ltr">
                          <div className="screen-reader-response">
                            <p role="status" aria-live="polite" aria-atomic="true"></p>
                            <ul></ul>
                          </div>
                          <form action="/solutions/buddy-can/#wpcf7-f1514-p674-o2" method="post" className="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init">
                            ...
                            <p style={{display: "none"}} className="akismet-fields-container" data-prefix="_wpcf7_ak_">
                              ...
                              <input type="hidden" id="ak_js_2" name="_wpcf7_ak_js" value="28" />
                            </p>
                            <div className="wpcf7-response-output" aria-hidden="true"></div>
                          </form>
                        </div>
                ...
                <div className="elementor-element elementor-element-976e1b1 elementor-widget elementor-widget-shortcode" data-id="976e1b1" data-element_type="widget" data-widget_type="shortcode.default">
                  <div className="elementor-widget-container">
                      ...
                      <div className="cms-menu-wraps relative">
                        ...
                        <div className="menu-solutions-footer-container">
                          <ul id="menu-solutions-footer" className="cms-menu cms-menu-vert -">
                            ...
                            <li id="menu-item-4508" className="menu-item menu-item-type-post_type menu-item-object-solutions current-menu-item menu-item-4508">
                              <a href="/solutions/buddy-can" aria-current="page" className="cms-menu-link link-white link-hover-accent bg-transparent bg-hover-transparent text-14">
                                <span className="menu-title title">
                                  Buddy Can
                                </span>
                              </a>
