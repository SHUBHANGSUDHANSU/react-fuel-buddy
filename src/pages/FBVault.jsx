    ...
    <div id="cms-page" className="cms-page">
                    ...
                    <ul id="cms-primary-menu" className="cms-primary-menu clearfix">
                      ...
                      <li id="menu-item-6022" className="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor current-menu-parent menu-item-has-children menu-item-6022">
                        ...
                        <ul className="sub-menu">
                          ...
                          <li id="menu-item-6031" className="menu-item menu-item-type-post_type menu-item-object-solutions current-menu-item menu-item-6031">
                            <a href="/solutions/fb-vault" aria-current="page" className="cms-menu-link">
                              <span className="menu-title-wraps">
                                <span className="menu-title title">
                                  FB-Vault
                                </span>
      ...
      <div id="cms-main" className="cms-main cms-main-elementor">
        <div className="cms-content-container elementor-container">
          <div data-elementor-type="wp-post" data-elementor-id="672" className="elementor elementor-672" data-elementor-post-type="solutions">
            <div className="elementor-section elementor-top-section elementor-element elementor-element-f5aca11 elementor-section-full_width elementor-section-height-default elementor-section-height-default cms-remove-container-max-width-no cms-full-content-with-space-none cms-boxed-bg-false cms-overlay-gradient-mode-bt cms-overlay-gradient-bg-yes" data-id="f5aca11" data-element_type="section">
              <div className="cms-overlay-gradient"></div>
              <div className="cms-section-boxed-bg"></div>
              <div className="elementor-container elementor-column-gap-no">
                <div className="elementor-column elementor-col-100 elementor-top-column elementor-element elementor-element-24a61051" data-id="24a61051" data-element_type="column">
                  <div className="elementor-widget-wrap elementor-element-populated">
                    <div className="elementor-element elementor-element-494f97ea cms-page-title-layout-4 elementor-widget elementor-widget-cms_page_title" data-id="494f97ea" data-element_type="widget" data-widget_type="cms_page_title.default">
                      <div className="elementor-widget-container">
                        <div className="cms-page-title-wrapper cms-overlay-gradient-1 text-center" style={{backgroundImage: "url(https://www.fuelbuddy.in/wp-content/uploads/2022/10/10.jpg)"}}>
                              ...
                              <div className="cms-page-title-content-col col-12 col-tablet-8 col-desktop-6">
                                <div className="cms-page-title-content">
                                  ...
                                  <div className="cms-desc text-17 font-700 pt-20 mt-n3 text-white">
                                    Your One-Stop-Solution for Vehicle Health Monitoring and Tracking 
                                    <div className="extra-space clearfix"></div>
                                  </div>
            ...
            <div className="elementor-section elementor-top-section elementor-element elementor-element-62f2e43 p-tb-40 p-tb-tablet-90 elementor-reverse-mobile elementor-section-boxed elementor-section-height-default elementor-section-height-default cms-remove-container-max-width-no cms-boxed-bg-false cms-overlay-gradient-mode-bt cms-overlay-gradient-bg-yes" data-id="62f2e43" data-element_type="section">
              <div className="cms-overlay-gradient"></div>
              <div className="cms-section-boxed-bg"></div>
              <div className="elementor-container elementor-column-gap-default">
                <div className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-14a4632" data-id="14a4632" data-element_type="column">
                  <div className="elementor-widget-wrap elementor-element-populated">
                    <div className="elementor-element elementor-element-5657a9c cms-form-field-border-grey4 cms-form-field-border-grey4 cms-cf7-layout-1 elementor-widget elementor-widget-global elementor-global-5465 elementor-widget-cms_ctf7" data-id="5657a9c" data-element_type="widget" data-settings={"{\"sticky\":\"top\",\"sticky_parent\":\"yes\",\"motion_fx_motion_fx_scrolling\":\"yes\",\"motion_fx_devices\":[\"desktop\",\"tablet_extra\",\"tablet\",\"mobile\"],\"sticky_on\":[\"desktop\",\"tablet_extra\",\"tablet\",\"mobile\"],\"sticky_offset\":0,\"sticky_effects_offset\":0}"} data-widget_type="cms_ctf7.default">
                      <div className="elementor-widget-container">
                        <div className="cms-cf7 relative p-tb-50 p-lr-20 p-lr-lg-50 bg-white cms-shadow-1 cms-radius-16">
                          <div className="cms-cf7-inner">
                            ...
                            <div className="wpcf7 no-js" id="wpcf7-f1514-p672-o1" lang="en-US" dir="ltr">
                              ...
                              <form action="https://formspree.io/f/xkoowlbe" method="post" className="wpcf7-form init" aria-label="Contact form" novalidate="novalidate" data-status="init" data-form-key="fb-vault" onSubmit={handleSubmit}>
                                ...
                                <p style={{display: "none"}} className="akismet-fields-container" data-prefix="_wpcf7_ak_">
                                  ...
                                  <input type="hidden" id="ak_js_1" name="_wpcf7_ak_js" value="161" />
                                </p>
                ...
                <div className="elementor-column elementor-col-50 elementor-top-column elementor-element elementor-element-3fa5595a" data-id="3fa5595a" data-element_type="column">
                  <div className="elementor-widget-wrap elementor-element-populated">
                    <div className="elementor-element elementor-element-391b947 elementor-widget elementor-widget-heading" data-id="391b947" data-element_type="widget" data-widget_type="heading.default">
                      <div className="elementor-widget-container">
                    ...
                    <div className="elementor-element elementor-element-74eaad11 elementor-widget elementor-widget-text-editor" data-id="74eaad11" data-element_type="widget" data-widget_type="text-editor.default">
                      <div className="elementor-widget-container">
                        <style dangerouslySetInnerHTML={{ __html: `
                        ...
                        ` }} />
                         The smooth running of vehicles is a must when it comes to logistics or going on trips. Uncover your one-stop solution to monitor and track your vehicle's health. With FB Vault you can do multiple things & ensure that you never have to worry about the health & safety of your vehicle. 
                      </div>
                    </div>
                    <div className="elementor-element elementor-element-4be8342 elementor-widget elementor-widget-heading" data-id="4be8342" data-element_type="widget" data-widget_type="heading.default">
                      <div className="elementor-widget-container">
                        <h2 className="elementor-heading-title elementor-size-default">
                          What Makes It Great?
                        </h2>
                    ...
                    <div className="elementor-element elementor-element-1077484 elementor-widget elementor-widget-html" data-id="1077484" data-element_type="widget" data-widget_type="html.default">
                      <div className="elementor-widget-container">
                        <h4>
                          Diesel Monitoring:
                        </h4>
                        <p>
                          Easily keep tabs on your diesel consumption with FB Vault. Our system continuously tracks diesel levels and consumption, providing valuable insights to help you save money and reduce your carbon footprint.
                        </p>
                        <h4>
                          Ad-blue Tracking:
                        </h4>
                        <p>
                          Ensure seamless Ad-blue management with FB Vault. Keep a check on Ad-blue levels effortlessly, eliminating concerns about running low on this essential component crucial for vehicle emissions control.
                        </p>
                        <h4>
                          Diagnostics Insights:
                        </h4>
                        <p>
                          FB Vault offers comprehensive diagnostic insights for a healthy vehicle. Monitor key components such as:
                        </p>
                        <ul>
                          <li>
                            <strong>
                             ...
                             Keep a vigilant eye on the heart of your vehicle's electrical system.
                          </li>
                          <li>
                            <strong>
                              Engine Temperature:
                            </strong>
                             Maintain optimal engine temperature to prevent overheating.
                          </li>
                          <li>
                            <strong>
                              Intake Manifold:
                            </strong>
                             Ensure your engine is breathing efficiently.
                          </li>
                          <li>
                            <strong>
                              Air Filter:
                            </strong>
                             Guarantee top-notch air quality supplied to your engine.
                          </li>
                          <li>
                            <strong>
                              Diesel Trim Diagnostics:
                            </strong>
                             Fine-tune your Diesel mixture for peak performance.
                          </li>
                        </ul>
                        <h4>
                          Fleet Performance:
                        ...
                        <p>
                          Evaluate the performance of your entire fleet with detailed statistics and analytics provided by FB Vault. Optimize your operations based on real data, enhancing efficiency and reducing costs.
                        </p>
                        <h4>
                          Operations Automation:
                        </h4>
                        <p>
                          Simplify your operations with FB Vault by automating routine tasks. This streamlines processes, minimizes errors, and saves valuable time, allowing you to focus on strategic aspects of fleet management.
                        </p>
                        <h4>
                          Track and Trace:
                        </h4>
                        <p>
                          Keep a close eye on your vehicles' real-time whereabouts with FB Vault's Track and Trace feature. Effortlessly monitor routes and schedules, ensuring efficient operations.
                        </p>
                        <p>
                          FB Vault is designed to be user-friendly, catering to both professional fleet managers and individuals seeking to improve their vehicle's health and performance. No matter your expertise level, FB Vault has you covered.
                        </p>
                      </div>
                    </div>
                    <div className="elementor-element elementor-element-1bdf3a4 pt-20 elementor-hidden-desktop elementor-hidden-tablet_extra elementor-hidden-tablet elementor-hidden-mobile cms-charts cms-chart-layout-1 elementor-widget elementor-widget-cms_chart" data-id="1bdf3a4" data-element_type="widget" data-widget_type="cms_chart.default">
                      <div className="elementor-widget-container">
                          ...
                          <div className="col-mobile-6 pt-50">
                            <div className="cms-sticky">
                              <div className="cms-charts-chart m-lr-auto mb-20">
                                <canvas id="cms_chart-1bdf3a4" className="cms-charts" data-settings={"{\"type\":\"doughnut\",\"labels\":[\"Retail\",\"Sciences\",\"Industrial\",\"Power\",\"Oil & Gas\"],\"value\":[40,20,15,15,10],\"colors\":[\"#9bcb3b\",\"#5553ce\",\"#f13a30\",\"#f8a137\",\"#1875f0\"],\"legend_display\":\"false\",\"legend_position\":null,\"title_display\":\"false\",\"title_position\":null,\"title_text\":null}"}></canvas>
                              </div>
            ...
            <div className="elementor-element elementor-element-933cfab e-flex e-con-boxed e-con e-parent" data-id="933cfab" data-element_type="container" data-settings={"{\"content_width\":\"boxed\"}"} data-core-v316-plus="true">
              <div className="e-con-inner">
                <div className="elementor-element elementor-element-38b18d1 elementor-widget elementor-widget-shortcode" data-id="38b18d1" data-element_type="widget" data-widget_type="shortcode.default">
                  <div className="elementor-widget-container">
                      ...
                      <div className="cms-menu-wraps relative">
                        ...
                        <div className="menu-solutions-footer-container">
                          <ul id="menu-solutions-footer" className="cms-menu cms-menu-vert -">
                            ...
                            <li id="menu-item-4509" className="menu-item menu-item-type-post_type menu-item-object-solutions current-menu-item menu-item-4509">
                              <a href="/solutions/fb-vault" aria-current="page" className="cms-menu-link link-white link-hover-accent bg-transparent bg-hover-transparent text-14">
                                <span className="menu-title title">
                                  FB-Vault
                                </span>
                              </a>
